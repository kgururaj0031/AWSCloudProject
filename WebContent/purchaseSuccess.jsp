    ...
    <div class="container">
        ...
        <!-- /.row --><div class="w3ls-banner">
			...
			<div class="agile-form">
				<form action="viewService.jsp" method="post">
									<ul class="field-list">
						<h2> PURHASE HAS BEEN SUCCESSFUL</h2>		
						<div>  
            <img alt="mobile cloud image" src="images/success.png" style="max-width:100%;">           
            </div>						
					</ul>
					</br>
					</br>
					<input type="submit" value="Go back to Services">
				</form>	
			</div>
		</div>
</div>
