        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                      <a href="idmsendKey.jsp">IDM Key </a> 
                    </li>
                    
                     <li>
                      <a href="idmLogin.jsp">Logut</a> 
                    </li>
                    </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
             ...
             <form action="IDMKeyGen" method="Post" name="s" onsubmit="return valid()"> 
            <div>
		  	...
		  	<table><tr> 
                ...
                <%
					String error=(String)request.getAttribute("success");
					if(error !=null){%>
					<font color="red">Done Key Generate...Plz Check the Mail...<a href="cscSecLogin.jsp">Secure login to user..</a> </font>	
						&nbsp;<%}
				%>
                  </font></td>
        </tr></table>
