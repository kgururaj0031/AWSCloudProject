...
<body style = "background: url(images/cloud.jpg); background-size:100% 100%;">
    ...
    <div class="container">
        ...
        <form class="button active" action = "deleteUser.jsp" name="s" method="post" onsubmit="return valid()">
        
							<input type="submit" name="sub" value="Delete User" class="submit"></input>
							<div class="clear"></div>	
							</form>
							</div></td>
