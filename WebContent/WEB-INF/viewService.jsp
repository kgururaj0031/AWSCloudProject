...
<body style = "background: url(images/cloud.jpg); background-size:100% 100%;">
    ...
    <div class="container">
       ...
       <table class="table table-hover" border="1">
        ...
        <form class="button active" action = "purchaseService.jsp" name="s" method="post" onsubmit="return valid()">
        
							<input type="submit" name="sub" value="Purchase" class="submit"></input>
							<div class="clear"></div>	
							</form>
							</div></td>
							<td> <div id="form_wrapper3" class="form_wrapper3">
  							 
        <form class="button active" action = "addComment.jsp" name="s" method="post" onsubmit="return valid()">
        
							<input type="submit" name="sub" value="Review" class="submit"></input>
							<div class="clear"></div>	
							</form>
							</div></td>
