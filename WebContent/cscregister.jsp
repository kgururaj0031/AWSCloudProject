    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
             ...
             <form action="CSCRegister" method="Post" name="s" onsubmit="return valid()"> 
            <div>
		 		...
		 		<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="mob" name="mob" maxlength="10">
		 		</div>
		 		<!-- <div class="checkbox">
		    		<label><input type="checkbox" id="remm"> Remember me</label>
		 		</div> -->
		  	...
		  	<table><tr> 
                ...
                <%
					String error=(String)request.getAttribute("regSuccess");
					if(error !=null){%>
					<font color="red">Done User Registration.Plz <a href="csclogin.jsp">Login Here</a>. </font>	
						&nbsp;<%}
				%>
                  </font></td>
        </tr></table>
