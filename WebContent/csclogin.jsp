        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                      <a href="csclogin.jsp">Login</a> 
                    </li>
                    
                     <li>
                      <a href="cscregister.jsp">Register</a> 
                    </li>
                    </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
             ...
             <form action="CSCLogin" method="Post" name="s" onsubmit="return valid()"> 
            <div>
		  	...
		  	<table><tr> 
                ...
                <%
					String error=(String)request.getAttribute("user");
					if(error !=null){%>
					<font color="red">Invalid Consumer </font>	
						&nbsp;<%}
				%>
                  </font></td>
        </tr></table>
